...
void  Adc3_Init(void)
{    
	ADC_CommonInitTypeDef ADC_CommonInitStructure; //定义一个结构体变量，名称是ADC_CommonInitStructure
	ADC_InitTypeDef       ADC_InitStructure; //定义一个结构体变量，名称是 ADC_InitStructure
  ...
  ADC_Init(ADC3, &ADC_InitStructure);//ADC初始化,并确定使用ADC3.
